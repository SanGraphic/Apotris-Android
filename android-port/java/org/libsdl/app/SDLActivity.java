...
import com.apotris.android.TouchOverlayManager;
...
*/
    ...
    protected static TouchOverlayManager mTouchOverlayManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyOrientationLayout(getResources().getConfiguration());
    ...
    protected void onStop() {
        Log.v(TAG, "onStop()");
        super.onStop();
        if (mTouchOverlayManager != null) {
            mTouchOverlayManager.stop();
        }
        if (mHasMultiWindow) {
            pauseNativeThread();
        }
    ...
    private void applyOrientationLayout(Configuration config) {
        boolean isPortrait = (config.orientation == Configuration.ORIENTATION_PORTRAIT);
        if (mSurface.getParent() != null) {
            ((ViewGroup) mSurface.getParent()).removeView(mSurface);
        }
        mLayout.removeAllViews();
        if (isPortrait) {
            nativeSetPortraitMode(true);
            LinearLayout portrait = new LinearLayout(this);
            portrait.setOrientation(LinearLayout.VERTICAL);
            portrait.setBackgroundColor(Color.BLACK);
            portrait.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        ...
        mTouchOverlayManager.attach(mLayout);
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mLayout != null && mTouchOverlayManager != null && mSurface != null) {
            mTouchOverlayManager.detach();
...
//        }
        ...
        if (SDLControllerManager.isDeviceSDLJoystick(deviceId)) {
            ...
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                if (mTouchOverlayManager != null) {
                    mTouchOverlayManager.onControllerInput();
                }
